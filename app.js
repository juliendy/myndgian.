...
console.log("date: ", todaysFullDate);
...
function updateSummary() {
    listedTodosText.forEach((todos) => {
        const listedTodosInlineText = document.getElementById(
            "listedTodosInlineText"
        );
...
function checkClickedIcon(e) {
    ...
    function openAddModal() {
        ...
        modalHeader.innerHTML =
            '<span class="header-span" style="color: var(--color-primary)">Add</span> A To-Do Item';
    ...
    function openEditModal() {
        ...
        modalHeader.innerHTML =
            '<span class="header-span" style="color: var(--color-primary)">Edit</span> Your To-Do Item';
    ...
    function openDeleteModal(item) {
        ...
        modalHeader.innerHTML =
            '<span class="header-span" style="color: var(--color-negative)">Delete</span> Your To-Do Item?';
        modalText1.textContent =
            "You will be unable to recover the data once it is deleted.";
